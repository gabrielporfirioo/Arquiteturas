...
def main():
    ...
    while True:
        ...
        print("5. Pesquiar Compromissos por Data")
        print("6. Sair")
        ...
        ##############
            ...
            compromissos = agenda.pesquisar_compromissos(data_inicio=data_inicio, data_fim=data_fim)
            for compromisso in compromissos:
                print(f"COMPROMISSO ENCONTRADO: \n Descrição: {compromisso[0]}, Data: {compromisso[1]}, Contato: {compromisso[2] or 'N/A'}")
        ###############
        elif opcao == '6':
            break
        else:
