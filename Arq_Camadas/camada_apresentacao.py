...
class CamadaApresentacao:
    ...
    def listar_compromissos_por_data(self):
        ...
        for compromisso in compromissos:
            print(f"COMPROMISSO ENCONTRADO: \n Descrição: {compromisso['descricao']}, Data: {compromisso['data']}, Contato: {compromisso['contato'] or 'N/A'}")
    ...
    def executar(self):
        while True:
            ...
            if opcao == '1':
                ...
                self.listar_compromissos_por_data()
            elif opcao == '6':
