...
class BancoDeDados:
    ...
    def listar_contatos(self):
        ...
        return [Contato(id, nome, telefone, email) for id, nome, telefone, email in cursor.fetchall()]
...
class Agenda:
    ...
    def adicionar_contato(self, nome, telefone, email):
        return self.db.adicionar_contato(nome, telefone, email)
...
class Interface:
    ...
    def adicionar_contato(self):
        ...
        id_contato = self.agenda.adicionar_contato(nome, telefone, email)
